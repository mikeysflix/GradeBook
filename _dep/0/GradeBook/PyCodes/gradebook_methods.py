...
class GradeBookEvaluationMethods():
    ...
    def __init__(self, bias='left'):
        ...
        self.distance_matrix.update_distance_metric('manhattan')
    ...
    def initialize_raw_data(self, fpath, index_by):
        """
...
class GradeBookStudentMethods(GradeBookEvaluationMethods):
...
class GradeBookEmailMethods(GradeBookStudentMethods):

    def __init__(self, bias='left', savedir=None):
        """
    ...
    def get_all_attachments(self):
        ...
        """
        attachments = []
        if self.visual_configuration.savedir is not None:
            for filename in os.listdir(self.visual_configuration.savedir):
                filepath = '{}{}'.format(self.visual_configuration.savedir, filename)
